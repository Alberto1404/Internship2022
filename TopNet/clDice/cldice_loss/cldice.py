...
class soft_dice_cldice(nn.Module):
    ...
    def forward(self, y_pred, y_true):
        ...
        # MODS from original clDice: work with uniform-radii vessels for soft-skeletonization, if not, soft-skeletonization won't be able to estimate the skelton correctly
