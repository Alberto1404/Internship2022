...
class UNETR_topnet_2(nn.Module):
	"""
	...
	def forward(self, x_in):
		...
		return self.out(out_1), self.out(out_2)
...
if __name__ == '__main__':
	...
	model = UNETR_topnet_2(in_channels=1, out_channels=1, img_size=(224,224,128), feature_size=16, hidden_size=768, mlp_dim=3072, num_heads=12, pos_embed='perceptron', norm_name='instance', res_block=True, dropout_rate=0, spatial_dims=3)
